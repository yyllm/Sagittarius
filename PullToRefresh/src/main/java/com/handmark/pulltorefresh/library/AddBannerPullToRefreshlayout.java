...
public class AddBannerPullToRefreshlayout extends PullToRefreshLayout {
    public AddBannerPullToRefreshlayout(Context context) {
        super(context);
        initGesture();
    }

    public AddBannerPullToRefreshlayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        initGesture();
    }

    public AddBannerPullToRefreshlayout(Context context, AttributeSet attrs, int defStyle) {
